...
import { Loader2, Calendar, DollarSign, Briefcase, Globe, Book } from "lucide-react";
            ...
            <div className="container mx-auto bg-white rounded-2xl  border border-gray-200">
                ...
                <div className="p-8 space-y-6">
                    ...
                    <div className="pt-6">
                        {/* Status Badge */}
                        <span
                            className={`inline-block px-4 py-2 rounded-full text-sm font-semibold ${assignment.status === "approved"
